...
from aigc_zoo.model_zoo.llm.ilql_model import MyILQLTransformer,EffiArguments,ILQLArguments
from aigc_zoo.utils.llm_generate import Generate
from config.ilql_config import global_args

if __name__ == '__main__':
    train_info_args['seed'] = None
    parser = HfArgumentParser((ModelArguments,ILQLArguments))
    model_args, ilql_args = parser.parse_dict(train_info_args,allow_extra_keys=True)
